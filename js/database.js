/**
 * database.js — Dados dos fármacos
 * ---------------------------------
 * Apenas a lista de drogas (AMLS.DRUGS). Constantes (instituições,
 * categorias, checklist RSI) foram movidas para constants.js.
 *
 * calcMode:
 ...
 *
 * rateBasis:
 *   'perMin'  → dose por minuto (×60 → mL/h)
 *   'perHour' → dose por hora
 *   'oneTime' → dose única (mL)
 */
